...
export default function TripIdeaCardPreview({id}) {
    ...
    return (
        <div className="flex border-gray-300 border-[2px] rounded-lg p-2 bg-white shadow-2xl scale-105 cursor-grabbing min-w-[300px] pointer-events-none">
            <img 
                ...
                className="w-20 h-20 border-none rounded-xl"
